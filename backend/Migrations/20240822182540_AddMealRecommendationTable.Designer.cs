...
namespace KONSUME.Migrations
{
    ...
    [Migration("20240822182540_AddMealRecommendationTable")]
    partial class AddMealRecommendationTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KONSUME.Core.Domain.Entities.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AllergiesSerialized = "[]",
                            CreatedBy = "1",
                            DateCreated = new DateTime(2024, 8, 22, 18, 25, 39, 665, DateTimeKind.Utc).AddTicks(3987),
            ...
            modelBuilder.Entity("KONSUME.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "1",
                            DateCreated = new DateTime(2024, 8, 22, 18, 25, 39, 500, DateTimeKind.Utc).AddTicks(3466),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "1",
                            DateCreated = new DateTime(2024, 8, 22, 18, 25, 39, 500, DateTimeKind.Utc).AddTicks(3485),
                            IsDeleted = false,
                            Name = "Patient"
                        });
                });
            ...
            modelBuilder.Entity("KONSUME.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "1",
                            DateCreated = new DateTime(2024, 8, 22, 18, 25, 39, 500, DateTimeKind.Utc).AddTicks(4121),
                            Email = "oyebohm@gmail.com",
                            FirstName = "Hasbiy",
                            IsDeleted = false,
                            LastName = "Oyebo",
                            Password = "$2a$10$0Ureuq7zZb7og0QE9sNRJOFvldLv3FLKXn7Yc5De8zxszXFqWUogK",
                            RoleId = 1
                        });
                });
